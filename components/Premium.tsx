  ...
  return (
    <div className="bg-background-light dark:bg-premium-bg-dark font-display text-premium-secondary dark:text-content antialiased h-screen w-full flex flex-col z-50 fixed inset-0 overflow-hidden">
      <div className="flex-1 overflow-y-auto no-scrollbar relative w-full">
        ...
        <div className="relative h-[42vh] min-h-[340px] w-full overflow-hidden rounded-b-[40px] shadow-2xl shadow-premium-secondary/20 shrink-0">
          <div
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/10 via-premium-bg-dark/20 to-premium-bg-dark/95 dark:to-premium-bg-dark" />
          ...
          <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center justify-end px-6 pb-10 text-center">
            ...
            <p className="mt-4 text-base font-medium leading-relaxed text-content/90 max-w-sm mx-auto">
              {t('premium.desc')}
            </p>
          </div>
        </div>

        <div className="flex flex-col px-5 pt-8 pb-44 gap-8">
          {!checkoutLive && (
          ...
          <section className="flex flex-col gap-3">
            <div className="px-1 flex items-center gap-1.5">
              <h2 className="text-sm font-bold uppercase tracking-wider text-premium-secondary/50 dark:text-content-subtle">
          ...
          <section className="flex flex-col gap-3">
            <h2 className="px-1 text-sm font-bold uppercase tracking-wider text-premium-secondary/50 dark:text-content-subtle">
