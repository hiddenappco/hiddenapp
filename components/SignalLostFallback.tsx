...
export const SignalLostFallback: React.FC<SignalLostFallbackProps> = ({
  ...
  return (
    <div className="min-h-screen w-full bg-background-dark font-display text-content flex flex-col overflow-hidden relative selection:bg-primary selection:text-white">
      <StickyGlassHeader
        onBack={onBack}
        onMenuClick={onMenuClick}
        title={t('menu.offlineHub')}
      />
